...
internal sealed class AsyncMutex
{
    ...
    public Task EnterAsync(CancellationToken cancellationToken)
    {
        ...
        Task Contended(CancellationToken cancellationToken)
        {
            ...
            lock (SyncObj)
            {
                ...
                {
                    Debug.Assert(_waitersTail.Next != null &&
                                 _waitersTail.Prev != null);
                    w.Next = _waitersTail;
    ...
    {
        public Waiter(AsyncMutex owner) : base(TaskCreationOptions
            .RunContinuationsAsynchronously) => Owner = owner;
